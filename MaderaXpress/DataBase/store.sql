...
--
-- Base de datos: `id16053937_store`
--
CREATE DATABASE IF NOT EXISTS `id16053937_store` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `id16053937_store`;
