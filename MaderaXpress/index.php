...
<body id="container-page-index">
    ...
    <div class="jumbotron" id="jumbotron-index">
      <h1><span class="tittles-pages-logo">MaderaXpress</span> <small style="color: #FF0000;">MX</small></h1>
      <p>
          Bienvenido a nuestra tienda de muebles, aqui encontrara una variedad de tipos de muebles para hogar.
      </p>
    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:20%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrese y hagase cliente de <span class="tittles-pages-logo">MaderaXpress</span> para recibir las mejores ofertas y descuentos especiales de nuestros productos.</p>
                        <p><a href="registration.php" class="btn btn-info btn-block">Registrarse</a></p>   
                   </article>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/PM1614_C1.png" alt="Smart-TV" class="img-responsive">
                </div>
            </div>
        </div>
    </section>
    <section id="distribuidores-index">
        <div class="container">
            ...
            <div class="col-xs-12">
                <div class="page-header">
                  <h1>Nuestros <small style="color: #FF0000;">Muebles</small></h1>
                </div>
                <br><br>
                <img src="assets/img/producto3.png" alt="logos-marcas" class="img-responsive">
            </div>
        </div>
    </section>
